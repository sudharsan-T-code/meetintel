...
export class MicrosoftTeamsProvider extends BaseIntegrationProvider {
  readonly id: IntegrationProviderType = 'microsoft_teams';
  ...
  constructor() {
    ...
    this.mockFallback = new MockIntegrationProvider('microsoft_teams');
  }
